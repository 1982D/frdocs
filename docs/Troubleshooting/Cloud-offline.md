...
This guide explains how to configure alert rules in OpsPilot that fire when any instance  -  or a specific job  -  has been offline for five minutes, using PromQL functions such as `unless` and `absent`.
