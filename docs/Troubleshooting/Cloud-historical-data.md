...
OpsPilot stores up to 13 months of metric data and up to 30 days of trace and log data, accessible through the Servers view, Applications list, and the Explore feature using the time picker.
